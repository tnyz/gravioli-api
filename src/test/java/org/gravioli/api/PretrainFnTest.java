...
public class PretrainFnTest {
    ...
    public void testService() throws IOException {
        ...
        String initialString = "{\"locations\":[{\"latitude\":1,\"longitude\":1,\"timestamp\":1}, " +
        ...
        Assert.assertEquals(stringWriter.getBuffer().toString(),
                "{\"deviceId\":null,\"activities\":[{\"label\":\"DWELL\",\"size\":3,\"startDate\":\"1970-01-01\",\"startTime\":\"00:00:01\",\"zone\":\"Africa/Sao_Tome\",\"duration\":0.03305555555555555,\"timeUnit\":\"HOURS\",\"locations\":{\"latitude\":[1.0,1.00000001,1.00000002],\"longitude\":[1.0,1.0,1.0]}}]}");
    }
}
